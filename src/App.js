  ...
  return (
    <>
      <div className='app'>
        ...
        <button style={{borderRadius: "50%", border: "0px", padding: "0px", width: "40px", height: "40px", position: "fixed", top: "10px", right: "10px"}} className="toggle-nav-button" onClick={toggleNav}  ><img src={`nav ? "https://shaswatag.github.io/PRODIGY_WD_04/images/list.svg" : "https://shaswatag.github.io/PRODIGY_WD_04/images/x.svg"`} /></button>
          <Home />
          <About />
          <Skills />
          <Projects />
